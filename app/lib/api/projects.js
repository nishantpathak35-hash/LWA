  ...
  try {
    ...
    overrides.forEach(row => {
      ...
      projectsMap[name] = {
        ...
        inflow,
        invoiceValue,
        project_ref: row.project_ref || projectsMap[name].project_ref || '',
        client: row.client || projectsMap[name].client || '',
        site_address: row.site_address || projectsMap[name].site_address || '',
        tds,
